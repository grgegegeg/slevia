...
package net.mcreator.sleviapack.gui;
...
import net.mcreator.sleviapack.procedure.ProcedureAcaa;
...
public class GuiAfa extends ElementsSleviapack.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiAfa(ElementsSleviapack instance) {
		super(instance, 8);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 71, 63) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 12, 18) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemQwert.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 12, 35) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				Sleviapack.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("sleviapack:textures/afa.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u0414\u0435\u043D\u0435\u0436\u043D\u044B\u0439 \u041F\u0440\u0438\u043D\u0442\u0435\u0440", 2, 2,
					-16777216);
			this.fontRenderer.drawString("\u041A\u0430\u0440\u0442\u0440\u0438\u0434\u0436", 29, 34, -16777216);
			this.fontRenderer.drawString("\u0421\u043F\u0435\u0446. \u0442\u043A\u0430\u043D\u044C", 29, 16, -16777216);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 7, this.guiTop + 61, 60, 20, "print"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			Sleviapack.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				ProcedureAcaa.executeProcedure($_dependencies);
			}
		}
	}
